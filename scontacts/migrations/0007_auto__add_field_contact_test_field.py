...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Contact.test_field'
        db.add_column(u'scontacts_contact', 'test_field',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Contact.test_field'
        db.delete_column(u'scontacts_contact', 'test_field')
    ...
    models = {
        u'scontacts.contact': {
            ...
            'last_review_time': ('django.db.models.fields.DateTimeField', [], {}),
            ...
            'test_field': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
